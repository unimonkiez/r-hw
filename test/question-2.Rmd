...
```
  ...
  השתמשו בקוד R ו/או בנוסחאות שנלמדו בשיעור כדי לענות על השאלה.
      ...
      * ניתן לבצע מבחן Welch's t-test שמתאים עבור דגימות מאוכלוסיות עם שונות לא זהה.  
      ...
      קיבלנו p-value הגדול מן 0.05 לכן ניתן לשלול את הנחת האפס כי הממוצע של האוכלוסיות מהם באו המדגמים זהה, ולקבל את ההנחה האלטרנטיבית כי יש הבדל בממוצעים.  
  ...
  השתמשו בקוד R ו/או בנוסחאות שנלמדו בשיעור כדי לענות על השאלה.
      ...
      בדומה לסעיף קודם אך הפעם ידוע כי האוכלוסיות מתפלגות נורמלית אז תנאי זה מתקיים (ואין צורך במשפט הגבול המרכזי)

      ```{r}
      t.test(X, Y, alternative = "two.sided");
      ```
      קיבלנו p-value קטן מ0.05 ולכן אי אפשר לשלול את הנחת האפס כי הממוצעים של אוכלוסיות הדגימות שווים.  
